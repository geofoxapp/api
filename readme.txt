...
Contents:
	Section A: Service input standards
	Section B: Service output standards
	Section C: Handling errors
	Section D: Writing service actions and modules
	Section E: Currently accessible actions
...
The "code" referenced earlier specifies the last server status code as referenced in Section F of 
this file. THIS IS A WORK IN PROGRESS.
